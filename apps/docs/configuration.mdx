...
Custom Docker images to auto-build when the server starts or when running `isol8 setup`. Each entry defines a named image with a runtime and list of packages.
