...
<AccordionGroup>
  ...
  <Accordion title="What is the difference between --persist and cleanup.autoPrune?">
  ...
  <Accordion title="What does --debug do?">
  ...
  <Accordion title="How do --persist and --debug interact?">
  ...
  <Accordion title="What is the difference between ephemeral and persistent mode?">
    ...
    | Performance | ~125-145ms (warm pool) | ~250-300ms first run, then ~120ms |
...
<AccordionGroup>
  <Accordion title="When should I use none vs filtered vs host network mode?">
  ...
  <Accordion title="Why does --net in the CLI ignore the config file default?">
...
<AccordionGroup>
  <Accordion title="Why do .ts files run with Bun instead of Deno?">
  ...
  <Accordion title="Why can't I use -e (inline code) with Deno?">
  ...
  <Accordion title="Why does my persistent container reject a different runtime?">
...
<AccordionGroup>
  <Accordion title="Why do packages fail with 'Operation not permitted'?">
  ...
  <Accordion title="What is the difference between --sandbox-size and --tmp-size?">
...
<AccordionGroup>
  <Accordion title="How does secret masking work?">
  ...
  <Accordion title="Can secrets leak through file outputs?">
