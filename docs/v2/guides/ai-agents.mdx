...
The most common use case for isol8 is giving an AI agent (ChatGPT, Claude, a custom LLM) the ability to write and execute code safely. The agent generates code, isol8 runs it in a sandbox, and the result is returned to the agent for further reasoning.
