...
<Accordion title="When should I read Execution vs Passing values?">
  Read <a href="/execution">Execution guide</a> for behavior and lifecycle. Read <a href="/passing-values">Passing values</a> to map each option to CLI, config, API, and library inputs.
</Accordion>
...
- **Command works differently than expected**: verify where the value is set in <a href="/passing-values">Passing values</a>.
