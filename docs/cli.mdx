...
<ResponseField name="--pool-strategy <mode>" type="fast | secure" default="fast">
  Ephemeral container pool strategy.
</ResponseField>

<ResponseField name="--pool-size <size>" type="number | clean,dirty" default="1,1">
  Pool size. Examples: `2` or `2,2`.
</ResponseField>
