...
og:title: "isol8 config - CLI Reference"
og:description: "View the active isol8 configuration. Debug your setup by inspecting merged defaults and config file values."
---
