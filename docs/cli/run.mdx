...
<ResponseField name="--stream" type="boolean" default="false">
  Stream output in real-time. Without this flag, output is buffered and displayed after execution finishes. Useful for long-running processes or watching progress.
</ResponseField>
