...
<ResponseField name="security.seccomp" type="string" default="strict">
  The seccomp profile to use:
  - `strict`: Blocks dangerous syscalls like `mount`, `ptrace`, and kernel module operations (safe default).
