...
og:title: "File Transfer - isol8 Library"
og:description: "Read and write files in isol8 containers. Use per-request injection or the persistent file API for data transfer."
---
